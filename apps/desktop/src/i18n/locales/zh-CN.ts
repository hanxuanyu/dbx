...
export default withEnglishFallback({
  ...
  settings: {
    ...
    syncS3Title: "S3 同步",
    syncS3Description: "通过已安装的官方 S3 插件上传或恢复同一份 DBX 快照。",
    syncS3NoConnections: "请先创建 S3 连接，再配置 S3 同步。",
    syncS3CreateConnection: "创建 S3 连接",
    syncS3Connection: "S3 连接",
    syncS3SelectConnection: "选择连接",
    syncS3Bucket: "存储桶",
    syncS3SelectBucket: "选择存储桶",
    syncS3FixedBucket: "此连接已固定使用连接中配置的存储桶。",
    syncS3BucketDescription: "存储桶列表从所选连接自动加载。",
    syncS3AddressingStyle: "寻址方式",
    syncS3AddressingStyleDescription: "继承连接配置，并由 S3 插件应用。",
    syncS3ObjectUri: "对象 URI",
    syncS3TestSuccess: "S3 目标可访问。",
    ...
    syncSecretsSharedDescription: "WebDAV 和 S3 使用此密码加密包含的敏感信息。GitHub Gist 和 Gitee 代码片段使用独立的加密和敏感信息选项。",
