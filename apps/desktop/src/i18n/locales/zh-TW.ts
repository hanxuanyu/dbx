...
export default withEnglishFallback({
  ...
  settings: {
    ...
    syncS3Title: "S3 同步",
    syncS3Description: "透過已安裝的官方 S3 外掛上傳或還原相同的 DBX 快照。",
    syncS3NoConnections: "請先建立 S3 連線，再設定 S3 同步。",
    syncS3CreateConnection: "建立 S3 連線",
    syncS3Connection: "S3 連線",
    syncS3SelectConnection: "選擇連線",
    syncS3Bucket: "儲存桶",
    syncS3SelectBucket: "選擇儲存桶",
    syncS3FixedBucket: "此連線已固定使用設定的儲存桶。",
    syncS3BucketDescription: "儲存桶會從所選連線載入。",
    syncS3AddressingStyle: "定址方式",
    syncS3AddressingStyleDescription: "繼承連線設定，並由 S3 外掛套用。",
    syncS3ObjectUri: "物件 URI",
    syncS3TestSuccess: "S3 目標可存取。",
    ...
    syncSecretsSharedDescription: "WebDAV 和 S3 會使用此密碼加密包含的敏感資訊。GitHub Gist 和 Gitee 程式碼片段使用獨立的加密和憑證設定。",
