...
export default withEnglishFallback({
  ...
  settings: {
    ...
    syncS3Title: "Sincronização S3",
    syncS3Description: "Envie ou restaure o mesmo snapshot do DBX pelo plugin oficial do S3 instalado.",
    syncS3NoConnections: "Crie uma conexão S3 antes de configurar a sincronização S3.",
    syncS3CreateConnection: "Criar conexão S3",
    syncS3Connection: "Conexão S3",
    syncS3SelectConnection: "Selecionar uma conexão",
    syncS3Bucket: "Bucket",
    syncS3SelectBucket: "Selecionar um bucket",
    syncS3FixedBucket: "Esta conexão está fixada no bucket configurado.",
    syncS3BucketDescription: "Os buckets são carregados da conexão selecionada.",
    syncS3AddressingStyle: "Estilo de endereçamento",
    syncS3AddressingStyleDescription: "Herdado da conexão e aplicado pelo plugin S3.",
    syncS3ObjectUri: "URI do objeto",
    syncS3TestSuccess: "O destino S3 está acessível.",
    ...
    syncSecretsSharedDescription: "Para WebDAV e S3, esta senha criptografa as credenciais incluídas. GitHub Gist e Gitee usam controles independentes de criptografia e credenciais.",
