...
export default withEnglishFallback({
  ...
  settings: {
    ...
    syncS3Title: "S3同期",
    syncS3Description: "インストール済みの公式S3プラグインを通じて、同じDBXスナップショットをアップロードまたは復元します。",
    syncS3NoConnections: "S3同期を設定する前にS3接続を作成してください。",
    syncS3CreateConnection: "S3接続を作成",
    syncS3Connection: "S3接続",
    syncS3SelectConnection: "接続を選択",
    syncS3Bucket: "バケット",
    syncS3SelectBucket: "バケットを選択",
    syncS3FixedBucket: "この接続では設定済みのバケットを固定で使用します。",
    syncS3BucketDescription: "バケットは選択した接続から読み込まれます。",
    syncS3AddressingStyle: "アドレス方式",
    syncS3AddressingStyleDescription: "接続設定を引き継ぎ、S3プラグインが適用します。",
    syncS3ObjectUri: "オブジェクトURI",
    syncS3TestSuccess: "S3ターゲットに接続できます。",
    ...
    syncSecretsSharedDescription: "WebDAV と S3 では、このパスワードで含める認証情報を暗号化します。GitHub Gist と Gitee スニペットでは独立した暗号化と認証情報の設定を使用します。",
